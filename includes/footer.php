<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Black Friday Fashion.<br>
				180 Regent hill Street, Gaborone.
			</address>
				<div class="phone">
					Telephone:
				...
				<div class="email">
					Email:
					<a href="mailto:contactus@gmail.com" class="email__addr">contactus@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2022 Black Friday Fashion&trade;
			</div>
